...
# @rnx-kit/css-style-to-react-native-style

[![Build](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml/badge.svg)](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml)
[![npm version](https://img.shields.io/npm/v/@rnx-kit/css-style-to-react-native-style)](https://www.npmjs.com/package/@rnx-kit/css-style-to-react-native-style)
...
```sh
yarn add @rnx-kit/css-style-to-react-native-style --dev
```

or if you're using npm

```sh
npm add --save-dev @rnx-kit/css-style-to-react-native-style
```
